...
public class Hotel implements Parcelable {
    ...
    public Hotel(String name, String longitud, String latitude, String address, String postalCode, String city, String country, String phone, String web, String email, ArrayList<Picture> pictures) {
        this.name = name;
