...
public class Place implements Parcelable {
    ...
    public Place(String name, String longitud, String latitude, String address, String postalCode, String city, String country, String phone, String web, ArrayList<Picture> pictures) {
        this.name = name;
