...
public class PointOfInterest implements Parcelable {
    ...
    public PointOfInterest(String name, String longitud, String latitude, String address, String postalCode, String city, String country, String phone, String web, String email, ArrayList<Picture> pictures) {
        this.name = name;
